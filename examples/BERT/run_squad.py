...
@predictor.entrypoint(max_analyze_depth=100, min_tracing_possibility=0.5, max_tracing_time=3, min_report_time=1, max_report_time=3)
...
def main():
    ...
    if args.local_rank == -1 or args.no_cuda:
        ...
        print("torch.distributed:", torch.distributed.get_world_size())
        n_gpu = 1
    ...
    if args.do_train:
        if args.fp16:
            ...
            optimizer = optim.SGD(model.parameters(), lr=args.learning_rate, bias_correction=False)
    ...
    if args.do_train:
        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(train_iter):
                ...
                # for p in model._module_parameters:
